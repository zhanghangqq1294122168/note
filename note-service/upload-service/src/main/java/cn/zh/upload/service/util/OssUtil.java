package cn.zh.upload.service.util;
...
public class OssUtil {
    ...
    private static String bucketName = "note-cloud";
    private static String endpoint = "oss-cn-shenzhen.aliyuncs.com";
    private static String accessKeyId = "LTAIflTS7BoroiEB";
    private static String accessKeySecret = "sp0XVVSUvdz9r7BtOwIgp22LdU9KuI";
